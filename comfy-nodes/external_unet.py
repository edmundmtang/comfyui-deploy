...
class ComfyUIDeployExternalUnet:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
            ...
            "optional": {
                "default_value": (folder_paths.get_filename_list("unet"), ),
                "display_name": (
                    "STRING",
...
NODE_CLASS_MAPPINGS = {
    "ComfyUIDeployExternalUnet": ComfyUIDeployExternalUnet}
NODE_DISPLAY_NAME_MAPPINGS = {
    "ComfyUIDeployExternalUnet": "External Unet (ComfyUI Deploy)"}
